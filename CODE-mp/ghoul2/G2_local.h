...
qboolean	G2API_SetBoneAnim(CGhoul2Info_v *ghoul2Ptr, const int modelIndex, const char *boneName, const int startFrame, const int endFrame,
...
qboolean	G2API_AttachG2Model(CGhoul2Info_v *ghoul2PtrFrom, int modelFrom, CGhoul2Info_v *ghoul2PtrTo, int toBoltIndex, int toModel);
...
qboolean	G2API_GetBoltMatrix(CGhoul2Info_v *ghoul2Ptr, const int modelIndex, const int boltIndex, mdxaBone_t *matrix,
...
void		G2API_CopySpecificG2Model(CGhoul2Info_v *ghoul2PtrFrom, int modelFrom, CGhoul2Info_v *ghoul2PtrTo, int modelTo);
