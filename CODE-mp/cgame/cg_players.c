...
doEssentialTwo:
	...
	{
		if (cg_entities[cent->currentState.number].teamPowerType == TEAMPOWER_ABSORB)
		...
		else
		{
			...
			if (cg_entities[cent->currentState.number].teamPowerType == TEAMPOWER_HEAL)
			{ //heal
				legs.shaderRGBA[0] = 0;
				legs.shaderRGBA[1] = 255;
				legs.shaderRGBA[2] = 0;
			}
			else if (cg_entities[cent->currentState.number].teamPowerType == TEAMPOWER_REGEN)
			{ //regen
				legs.shaderRGBA[0] = 0;
				legs.shaderRGBA[1] = 0;
...
doEssentialThree:
	...
	if (cg_entities[cent->currentState.number].teamPowerEffectTime > cg.time && cg_entities[cent->currentState.number].teamPowerType == TEAMPOWER_ABSORB)
