...
infoParm_t	infoParms[] = {
	// Game content Flags
	{"nonsolid", 	~CONTENTS_SOLID,	CONTENTS_NONE, 				CONTENTS_NONE },						// special hack to clear solid flag
	{"nonopaque", 	~CONTENTS_OPAQUE,	CONTENTS_NONE, 				CONTENTS_NONE },						// special hack to clear opaque flag
	{"lava",		~CONTENTS_SOLID,	CONTENTS_NONE,				CONTENTS_LAVA },			// very damaging
	{"slime",		~CONTENTS_SOLID,	CONTENTS_NONE,				CONTENTS_SLIME },			// mildly damaging
	{"water",		~CONTENTS_SOLID,	CONTENTS_NONE,				CONTENTS_WATER },
	{"fog",			~CONTENTS_SOLID,	CONTENTS_NONE,				CONTENTS_FOG},				// carves surfaces entering
	{"shotclip",	~CONTENTS_SOLID,	CONTENTS_NONE,				CONTENTS_SHOTCLIP },		/* block shots, but not people */
	{"playerclip",	~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_PLAYERCLIP },	   	/* block only the player */ 
	{"monsterclip",	~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_MONSTERCLIP },		
	{"botclip",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_BOTCLIP },		   	/* for bots */															
	{"trigger",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_TRIGGER },
	{"nodrop",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_NODROP },			// don't drop items or leave bodies (death fog, lava, etc)
	{"terrain",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_TERRAIN },		   	/* use special terrain collsion */										
	{"ladder",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_LADDER },			// climb up in it like water
	{"abseil",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_ABSEIL },			// can abseil down this brush
	{"outside",		~(CONTENTS_SOLID|CONTENTS_OPAQUE),CONTENTS_NONE,CONTENTS_OUTSIDE },			// volume is considered to be in the outside (i.e. not indoors)
																		
	{"detail",		CONTENTS_ALL,					CONTENTS_NONE,				CONTENTS_DETAIL },			// don't include in structural bsp
	{"trans",		CONTENTS_ALL,					CONTENTS_NONE,				CONTENTS_TRANSLUCENT },		// surface has an alpha component
